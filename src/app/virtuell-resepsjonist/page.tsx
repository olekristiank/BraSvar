...
export const metadata: Metadata = {
  title: 'Virtuell resepsjonist | Bra Svar!',
  description: 'En digital resepsjonist som svarer, booker og hjelper kundene dine — uten ventetid.',
};
    ...
    <main style={{ minHeight: '100vh', fontFamily: 'var(--font-outfit)', background: '#fff' }}>
      ...
      <div style={{
        ...
        <p style={{ fontSize: '1.05rem', color: '#64748b', maxWidth: '550px', margin: '0 auto 2rem', lineHeight: 1.6 }}>
          En digital resepsjonist som svarer, booker og hjelper kundene dine — uten ventetid.
        </p>
        <Link href="/" style={{
