    ...
    <main style={{ minHeight: '100vh', fontFamily: 'var(--font-outfit)', background: '#fff' }}>
      ...
      <div style={{
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>
            Bra Svar er utviklet av Klevstrand Innovasjon, et norsk teknologiselskap. Vi bygger AI-løsninger som hjelper småbedrifter å gi bedre kundeservice uten å ansette flere folk.
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>
            Vi lager KI-telefonassistenter som svarer telefonen for bedriften din med en naturlig norsk stemme. Assistenten booker timer, svarer på spørsmål og sender deg oppsummering etterpå.
          </p>
        </div>
