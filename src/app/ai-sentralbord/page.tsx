...
export const metadata: Metadata = {
  title: 'AI Sentralbord | Bra Svar!',
  description: 'Intelligent sentralbord som svarer telefonen for bedriften din — døgnet rundt.',
};
    ...
    <main style={{ minHeight: '100vh', fontFamily: 'var(--font-outfit)', background: '#fff' }}>
      ...
      <div style={{
        ...
        <p style={{ fontSize: '1.05rem', color: '#64748b', maxWidth: '550px', margin: '0 auto 2rem', lineHeight: 1.6 }}>
          Intelligent sentralbord som svarer telefonen for bedriften din — døgnet rundt.
        </p>
        <Link href="/" style={{
