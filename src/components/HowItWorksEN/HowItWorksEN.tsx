      ...
      <div className="w-full flex flex-col items-center relative z-10" style={{ maxWidth: '1100px' }}>
        ...
        <AnimateIn delay={0}>
          <div className="text-center px-4" style={{ marginBottom: '3rem', maxWidth: '800px', marginLeft: 'auto', marginRight: 'auto' }}>
            ...
            >
              Getting <span style={{ color: '#ec4899' }}>started</span>
            </h2>
          </div>
        </AnimateIn>
          ...
          {[
            {
              ...
              desc: 'Tell us about your services, frequently asked questions, how you interact with your customers, and how you want them to be greeted. We build the assistant for you, completely free of charge.',
              icon: '1',
            },
            {
              num: '2',
              title: 'Test and refine',
              desc: 'You quickly receive a first version on a dedicated phone number. Try it out and give us feedback. We fine-tune it until you are satisfied.',
              icon: '2',
            },
            {
              num: '3',
              title: 'Connect',
              desc: 'Forward your existing number and the assistant takes over. You choose: outside business hours, for unanswered calls, or 24/7. Your customers always get an answer, and you have full visibility through reports and insights in the dashboard.',
              icon: '3',
            },
          ].map((step, i) => (
