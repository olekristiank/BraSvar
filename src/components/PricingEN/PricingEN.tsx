        ...
        <AnimateIn delay={0}>
          <div className="text-center px-4" style={{ marginBottom: '3.5rem', maxWidth: '700px', marginLeft: 'auto', marginRight: 'auto' }}>
            ...
            <div className="flex flex-wrap justify-center" style={{ gap: '0.5rem 1.5rem' }}>
              {['No commitment', 'Free setup', 'Norwegian support'].map((item) => (
        ...
        >
          ...
          <AnimateIn delay={80}>
            <HoverCard className="flex flex-col w-full" baseStyle={{
              ...
              <p className="font-semibold uppercase" style={{ fontSize: '0.65rem', letterSpacing: '0.15em', color: '#94a3b8', marginBottom: '0.75rem' }}>Starter</p>
              ...
              <p className="text-slate-500" style={{ fontSize: '0.88rem', marginBottom: '1.75rem', lineHeight: 1.55, fontWeight: 450 }}>
                For businesses with low call volume and simple needs.
              </p>
              ...
              <div style={{ marginBottom: '1.75rem', paddingBottom: '1.75rem', borderBottom: '1px solid #f1f5f9' }}>
                ...
                <div className="flex items-baseline">
                  ...
                  <span className="text-slate-500 font-medium" style={{ fontSize: '0.9rem', marginLeft: '0.5rem' }}>/ mo</span>
                </div>
              </div>

              {/* Features */}
              <ul className="flex-1 flex flex-col" style={{ gap: '1rem', marginBottom: '2rem' }}>
                <Feature color="green">500 minutes</Feature>
                <Feature color="green">Appointment booking with one calendar</Feature>
                <Feature color="green">Small knowledge base</Feature>
                <Feature color="green">Can transfer calls to you</Feature>
                <Feature color="green">Speaks Norwegian!</Feature>
              </ul>
          ...
          <AnimateIn delay={160}>
            <HoverCard className="flex flex-col w-full relative" baseStyle={{
              ...
              <p className="font-semibold uppercase" style={{ fontSize: '0.65rem', letterSpacing: '0.15em', color: 'rgba(148,163,184,.7)', marginBottom: '0.75rem', paddingTop: '0.5rem' }}>Recommended</p>
              ...
              <p className="font-medium" style={{ color: '#94a3b8', fontSize: '0.88rem', marginBottom: '1.75rem', lineHeight: 1.55, fontWeight: 450 }}>
                For businesses that never want to miss a call.
              </p>
              ...
              <div style={{ marginBottom: '1.75rem', paddingBottom: '1.75rem', borderBottom: '1px solid rgba(71,85,105,.4)' }}>
                ...
                <div className="flex items-baseline">
                  ...
                  <span className="font-medium" style={{ fontSize: '0.9rem', marginLeft: '0.5rem', color: '#64748b' }}>/ mo</span>
                </div>
              </div>

              {/* Features */}
              <ul className="flex-1 flex flex-col" style={{ gap: '1rem', marginBottom: '2rem' }}>
                <Feature color="pink">1,000 minutes</Feature>
                <Feature color="pink">Appointment booking with multiple calendars</Feature>
                <Feature color="pink">Large knowledge base</Feature>
                <Feature color="pink">Can transfer to multiple call queues</Feature>
                <Feature color="pink">Speaks Norwegian and English</Feature>
                <Feature color="pink">2 concurrent calls</Feature>
                <Feature color="pink">Advanced call flow</Feature>
                <Feature color="pink">Simple integration with business systems</Feature>
                <Feature color="pink">Chat module on website</Feature>
                <Feature color="pink">Send SMS</Feature>
              </ul>
          ...
          <AnimateIn delay={240}>
            <HoverCard className="flex flex-col w-full" baseStyle={{
              ...
              <p className="font-semibold uppercase" style={{ fontSize: '0.65rem', letterSpacing: '0.15em', color: '#94a3b8', marginBottom: '0.75rem' }}>Custom</p>
              <h3 className="font-bold text-slate-900" style={{ fontSize: '1.4rem', marginBottom: '0.25rem' }}>Pro</h3>
              <p className="text-slate-500" style={{ fontSize: '0.88rem', marginBottom: '1.75rem', lineHeight: 1.55, fontWeight: 450 }}>
                For those who need something fully tailored, with custom integrations and a dedicated contact person.
              </p>
              ...
              {/* Features */}
              <ul className="flex-1 flex flex-col" style={{ gap: '1rem', marginBottom: '2rem' }}>
                <Feature color="green">Unlimited call minutes</Feature>
                <Feature color="green">Advanced integrations</Feature>
                <Feature color="green">Can make outbound calls for direct sales, customer surveys, and more</Feature>
              </ul>
