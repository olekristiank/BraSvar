...
const steps = [
  {
    ...
    desc: 'Your phone rings as usual. The customer notices no difference.',
    icon: (
  ...
  },
  {
    ...
    desc: 'The assistant answers immediately, asks questions, and finds out what the customer needs.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#ec4899" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    num: '3',
    title: 'The customer gets help',
    desc: 'Bra Svar can book appointments, answer questions, or transfer the call to you.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#ec4899" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function HowItWorksPreviewEN() {
  return (
    <section
    ...
    >
      <div className="w-full flex flex-col items-center" style={{ maxWidth: '1100px' }}>
        ...
        <AnimateIn delay={0}>
          <div className="text-center px-4" style={{ marginBottom: '2rem', maxWidth: '700px', marginLeft: 'auto', marginRight: 'auto' }}>
            ...
            <p style={{
              ...
              When someone calls you, Bra Svar answers right away and helps the customer move forward.
            </p>
          </div>
        </AnimateIn>
        ...
        <div
          ...
          style={{ gap: '0', marginTop: '0', maxWidth: '900px' }}
        >
          {steps.map((step, i) => (
