...
const allImages: { src: string; alt: string }[] = [
  { src: '/images/personas/plumber.jpg', alt: 'Plumber at work' },
  { src: '/images/personas/roofer.jpg', alt: 'Roofer on a roof' },
  { src: '/images/personas/therapist.jpg', alt: 'Therapist in consultation' },
  { src: '/images/personas/dentist.jpg', alt: 'Dentist with patient' },
  { src: '/images/personas/hairdresser.jpg', alt: 'Hairdresser with client' },
  { src: '/images/personas/mechanic.jpg', alt: 'Car mechanic in workshop' },
  { src: '/images/personas/lawyer.jpg', alt: 'Lawyer at office' },
  { src: '/images/personas/warehouse.jpg', alt: 'Warehouse worker' },
];
...
export default function RecognitionEN() {
